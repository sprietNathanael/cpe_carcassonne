...
public class InnsAndCathedralsSet implements SetInterface
{
    ...
    private void initiliazeSet()
    {
        ...
        tileList.add(new CasualTile("EG", "inncathedral", "EG", //Id
                ...
                new FieldType(), //West
                new CityType(), new CityType(), new FieldType(), new CityType(), //Center section
                aggregates
        ));
