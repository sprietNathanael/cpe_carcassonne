 ...
 */
public class TilePlacementMouseAdapter extends LayerMouseAdapter
{
    protected final GridPanel gridPanel;
    protected TilePlacementMouseListener listener;
     ...
     * @param listener 
     */
    TilePlacementMouseAdapter(GridPanel gridPanel, TilePlacementMouseListener listener)
    {
